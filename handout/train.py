...
def get_args():
    ...
    # Directory Settings
    parser.add_argument('--out_dir', type=str, default='lora-gpt-default',help='Output directory.')
    parser.add_argument('--init_from', type=str, default='gpt2' , help='Initialization method.')
...
def main():
    ...
    sampler = ModelSampler(out_dir=args.out_dir, init_from='resume', device=args.device, max_new_tokens=5, temperature=0.6, top_k=200, ckpt_last=True)
    accuracy, pos_counter, neg_counter, counter = sampler.get_accuracy()
